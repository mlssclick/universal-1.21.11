...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "universalmod.safeWorldEffects";
    private static final String SAFE_WORLD_EFFECTS_ENV = "UNIVERSALMOD_SAFE_WORLD_EFFECTS";

    private static Boolean disableFragEffectScanShader;
    private static String disableFragEffectScanShaderReason = "unresolved";
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "universalmod.disableFragEffectScanShader";
    private static final String DISABLE_FRAG_EFFECT_SCAN_ENV = "UNIVERSALMOD_DISABLE_FRAG_EFFECT_SCAN_SHADER";
